...
class MousForm(forms.Form):
    ...
    def save(self, *args, **kwargs):
        ...
        if created:
            action = DocumentLogs.ACTION.create_mou
        else:
            action = DocumentLogs.ACTION.update_mou
...
class ChangeRecordStatusForm(forms.Form):
    ...
    def save(self, *args, **kwargs):
        ...
        updated_by = self.user
        updated_date = timezone.now()
        action = DocumentLogs.ACTION.update_mou_record_status
...
class DeleteForm(forms.Form):
    ...
    def save(self, *args, **kwargs):
        ...
        action = DocumentLogs.ACTION.delete_mou
        updated_by = self.user
        updated_date = timezone.now()
...
class ChangeStatusForm(forms.Form):
    ...
    def save(self, *args, **kwargs):
        reason = self.cleaned_data['reason']
        action = DocumentLogs.ACTION.update_mou_status
...
class UploadForm(forms.Form):
    ...
    def save(self, *args, **kwargs):
        ...
        DocumentLogs.objects.create(document_id=self.document.id,
                                    document_subject=self.document.subject,
                                    action=DocumentLogs.ACTION.upload_mou_file,
                                    updated_by=self.user,
                                    updated_date=timezone.now())
...
class RemoveForm(forms.Form):
    ...
    def remove(self, *args, **kwargs):
        ...
        DocumentLogs.objects.create(document_id=document.id,
                                    ...
                                    action=DocumentLogs.ACTION.delete_mou_file,
                                    value=value,
                                    reason=self.cleaned_data['reason'],
                                    updated_by=self.user,
                                    updated_date=timezone.now())

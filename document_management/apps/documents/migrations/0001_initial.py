# Generated by Django 2.2.3 on 2019-08-06 14:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_type', models.PositiveSmallIntegerField(choices=[(1, 'Contract'), (2, 'MoU'), (3, 'Reading News')])),
                ('category', models.PositiveSmallIntegerField(choices=[(1, 'Property'), (2, 'Construction'), (3, 'Other')])),
                ...
                ('retention_period', models.CharField(blank=True, max_length=4, null=True)),

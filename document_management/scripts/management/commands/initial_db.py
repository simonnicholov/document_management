...
class Command(LoggingBaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Document.objects.bulk_create([
            ...
            # official record unrelated
            Document(partner=partner1, location=location2, number='OFFICIAL-RECORD-001',
                     ...
                     type=Document.TYPE.private, job_specification='Pemasangan alumunium'),
            Document(partner=partner2, location=location3, number='OFFICIAL-RECORD-002',
            ...
            Document(partner=partner3, location=location1, number='OFFICIAL-RECORD-003',
        ...
        document2 = Document.objects.get(id=2)

        document4 = Document.objects.get(id=4)
        document5 = Document.objects.get(id=5)
        ...
        Addendum.objects.bulk_create([
            ...
            Addendum(document=document2, number='CONTRACT-002-ADDENDUM-001',
                     ...
                     retention_period=90),
            Addendum(document=document2, number='CONTRACT-002-ADDENDUM-002',
                     subject='CONTRACT-002-ADDENDUM-002 Subject'),
            ...
            Addendum(document=document4, number='MOU-001-ADDENDUM-001',
                     ...
                     retention_period=80),
            Addendum(document=document4, number='MOU-001-ADDENDUM-002',
                     subject='MOU-001-ADDENDUM-002 Subject'),
        ...
        OfficialRecord.objects.bulk_create([
            ...
            OfficialRecord(document=document2, number='CONTRACT-002-OFFICIAL-RECORD-001',
                           ...
                           retention_period=90),
            OfficialRecord(document=document2, number='CONTRACT-002-OFFICIAL-RECORD-002',
                           subject='CONTRACT-002-OFFICIAL-RECORD-002 Subject'),
            ...
            OfficialRecord(document=document4, number='MOU-001-OFFICIAL-RECORD-001',
                           ...
                           retention_period=80),
            OfficialRecord(document=document4, number='MOU-001-OFFICIAL-RECORD-002',
                           subject='MOU-001-OFFICIAL-RECORD-002 Subject'),
